...
const questionsByCategory = [
  ...
  },
  {
    ...
    questions: [
      'What projects are you most proud of?',
      'Tell me about CloudMatch',
      'What is the Hindi Summarizer project?',
      'Show me your AI projects',
      'Tell me about BriefPT',
      'What is the COVID detection project?',
    ],
  },
  {
    id: 'skills',
    ...
    questions: [
      ...
      'Tell me about your statistical analysis skills',
  ...
  },
  {
    ...
    questions: [
      ...
      'Tell me about your internships and jobs.',
      'What did you do at GE Healthcare?',
      'Tell me about your role at EarnIn',
      'What was your experience at Reliance Jio?',
        ...
        <div className="w-full">
          ...
          >
            <button
              ...
              className="flex items-center gap-1 px-3 py-1 text-xs text-gray-500 transition-colors hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200"
            >
              {isVisible ? (
                <>
                  <ChevronDown size={14} />
